...
svm_model_imdb_nh_a = [] # svm model for imdb dataset (no hyperparameters)
svm_model_imdb_h_a = [] # svm model for imdb dataset (hyperparameters)
nb_model_imdb_nh_a = [] # naive bayes model for imdb dataset (no hyperparameters)
nb_model_imdb_h_a = [] # naive bayes model for imdb dataset (hyperparameters)
rf_model_imdb_nh_a = [] # random forest model for imdb dataset (no hyperparameters)
rf_model_imdb_h_a = [] # random forest model for imdb dataset (hyperparameters)




# Calculate Mann-Whitney U test for Twitter US Airline Sentiment Dataset